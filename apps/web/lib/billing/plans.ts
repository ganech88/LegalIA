...
export const PLANS: Record<PlanId, PlanDef> = {
  free: {
    ...
    consultasMes: 20,
    maxUsuarios: 1,
    features: ["3 escritos por mes", "20 consultas IA", "Calculadoras legales", "Exportar a Word"],
    checkout: false,
  },
  profesional: {
    id: "profesional",
    ...
    consultasMes: null,
    maxUsuarios: 1,
    features: ["30 escritos por mes", "Consultas IA ilimitadas", "Calculadoras legales", "Historial de escritos", "Soporte prioritario"],
    checkout: true,
  },
  estudio: {
    id: "estudio",
    ...
    consultasMes: null,
    maxUsuarios: 5,
    features: ["Escritos ilimitados", "Hasta 5 usuarios", "Mini CRM de casos", "Exportación masiva", "Soporte dedicado"],
    checkout: true,
  },
};
